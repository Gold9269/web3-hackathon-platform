    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Prize Pool (ETH)</label>
            <input type="number" step="0.01" placeholder="Prize Pool" {...register('prizePool', { required: true })} className="block w-full border-gray-300 rounded-md p-2" />
          ...
          <div>
            ...
            <select {...register("isVoteActive", { required: true })} className="block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 text-gray-900">
